...
void setup() {
  ...
  home_page = "HTTP/1.1 200 OK\r\n";
       ...
       home_page += "<option value=\"/sense\">Jam Band Sensing</option>";
  ...
  manual_page = "HTTP/1.1 200 OK\r\n";
       ...
       manual_page += "<option value=\"/sense\">Jam Band Sensing</option>";
  ...
  songs_page = "HTTP/1.1 200 OK\r\n";
       ...
       songs_page += "<option value=\"/sense\">Jam Band Sensing</option>";
       songs_page += "</select></html>\n";
  sense_page = "HTTP/1.1 200 OK\r\n";
       sense_page += "Content-Type: text/html\r\n\r\n";
       ...
       sense_page += "<option value=\"/beats\">Beat Sequencer</option>";
       sense_page += "<option value=\"/songs\">Pre-made Songs</option>";
       sense_page += "<option value=\"/sense\" selected>Jam Band Sensing</option>";
       sense_page += "</select></html>\n";
...
void generateBeatsHTML(String option) {
  ...
  beats_page = "HTTP/1.1 200 OK\r\n";
     ...
     beats_page += "<option value=\"/sense\">Jam Band Sensing</option>";
